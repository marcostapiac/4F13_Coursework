...
def BMM(A, B, K, alpha, gamma, num_iters_gibbs=10, seed=27):
    """
    ...
    for iter in tqdm(range(num_iters_gibbs)):
        for d in range(D):
            ...
            w = A[training_documents, 1]  # word ids of unique words in document d
...
if __name__ == '__main__':
    ...
    perplexity, swk, _, _ = BMM(A, B, K, alpha, gamma)
    print(perplexity)
    I = 20
